...
- speed up opencode workflows with pip cache and lighter install
...
- make opencode review approval reliable by separating agent decision from execution
...
- use options.apiKey format in config

## v0.8.14 (2026-06-24)

### Fix

- use single-line Python for YAML compatibility

## v0.8.13 (2026-06-24)

### Fix

- write Go API key directly to config file (no {env:} substitution)
...
- set opencode-go apiKey via global config with {env:} substitution

## v0.8.10 (2026-06-24)

### Fix

- create auth directory before writing auth.json
